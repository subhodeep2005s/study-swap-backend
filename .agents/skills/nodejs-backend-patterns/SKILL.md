...
// configure using a single connection URL from env
...
// use the connection string defined in REDIS_URL; ioredis will parse it
// automatically and supports TLS/SSL schemes like `rediss://`.
const redis = new Redis(process.env.REDIS_URL, {
  retryStrategy: (times) => {
