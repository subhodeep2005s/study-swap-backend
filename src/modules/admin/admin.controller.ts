...
import type {
  ...
  CreateCountryInput,
  UpdateCountryInput,
  CreateEducationNodeInput,
  UpdateEducationNodeInput,
} from "./admin.schema";
...
export const createCountry = asyncHandler(
  async (req: Request<unknown, unknown, CreateCountryInput>, res: Response) => {
...
export const updateCountry = asyncHandler(
  async (req: Request<{ id: string }, unknown, UpdateCountryInput>, res: Response) => {
...
export const getEducationNodesByCountry = asyncHandler(
  async (req: Request<{ countryId: string }>, res: Response) => {
...
export const createEducationNode = asyncHandler(
  async (req: Request<unknown, unknown, CreateEducationNodeInput>, res: Response) => {
...
export const updateEducationNode = asyncHandler(
  async (req: Request<{ id: string }, unknown, UpdateEducationNodeInput>, res: Response) => {
...
export const deleteEducationNode = asyncHandler(
...
export const getMentorsUsers = asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = await adminService.getMentorsUsers({
    page: Number(page) || 1,
    limit: Number(limit) || 20,
    search,
...
export const updateStudent = asyncHandler(
  async (req: Request<{ id: string }, unknown, any>, res: Response) => {
...
export const updateMentorUser = asyncHandler(
  async (req: Request<{ id: string }, unknown, any>, res: Response) => {
...
export const getMatches = asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = await adminService.getMatches({
    page: Number(page) || 1,
    limit: Number(limit) || 20,
  });
  res.status(200).json({
...
export const getMatchesByUser = asyncHandler(
...
export const getBookingsByMentor = asyncHandler(
  async (req: Request<{ id: string }>, res: Response) => {
...
export const regenerateMeetLink = asyncHandler(
  async (req: Request<{ id: string }>, res: Response) => {
...
// Availability (Merged)
// =========================================================================
export const getMentorAvailability = asyncHandler(
  async (req: Request<{ id: string }>, res: Response) => {
    const availability = await adminService.getMentorAvailability(req.params.id);
    res
      .status(200)
      .json({ success: true, message: "Mentor availability fetched", data: availability });
  },
);

export const updateMentorAvailability = asyncHandler(
  async (req: Request<{ id: string }>, res: Response) => {
    const availability = await adminService.updateMentorAvailability(
      req.params.id,
      req.body.availability,
    );
    res
      .status(200)
      .json({ success: true, message: "Mentor availability updated", data: availability });
  },
);
